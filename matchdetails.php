...
switch ($op) {
    ...
    case 'default':
        ...
        foreach ($map as $thismap) {
            ...
            $xoopsTpl->append('map', ['mapid'       => $thismap['mapid'],
                                      'edit'        => $edit,
                                      'mapno'       => $thismap['caption'],
                                      'linenumbers' => is_countable($lineuppos) ? count($lineuppos) : 0,
                                      'mapname'     => $thismap['name'],
                                      'ourscore'    => $thismap['ourscore'],
                                      'theirscore'  => $thismap['theirscore'],
                                      'color'       => $thismap['color'],
                                      'tacid'       => $thismap['tacid'],
                                      'screenshot'  => $thismap['screenshot'],
                                      'lineup'      => $lineup,
                                      'matchmapid'  => $thismap['matchmapid'],
            ]);
        }
