...
define('_MI_GAMERS_DESC', 'Создание секции для групп, матчей и доступности');

// Names of blocks for this module (Not all module has blocks)
define('_MI_GAMERS_BNAME1', 'Доступность');
define('_MI_GAMERS_BNAME2', 'Меню');

// Sub menus in main menu block
define('_MI_GAMERS_SMNAME2', 'Матчи');
define('_MI_GAMERS_SMNAME3', 'Перечень');
define('_MI_GAMERS_SMNAME4', 'Тактики');

// Names of admin menu items
define('_MI_GAMERS_ADMENU6', 'Управление группами');
define('_MI_GAMERS_ADMENU4', 'Управление картами');
define('_MI_GAMERS_ADMENU2', 'Управление матчами');
define('_MI_GAMERS_ADMENU3', 'Управление местоположением');
define('_MI_GAMERS_ADMENU7', 'Управление серверами');
define('_MI_GAMERS_ADMENU8', 'Управление численностью групп');
define('_MI_GAMERS_ADMENU9', 'Manage Sides');
define('_MI_GAMERS_ADMENU10', 'Управление рангами');

//Added 10/9-2003 Mithrandir for Notification
define('_MI_GAMERS_MATCH_NOTIFY', 'Матч');
define('_MI_GAMERS_MATCH_NOTIFYDSC', 'Notification options that apply to the current match');

define('_MI_GAMERS_NEWMATCH_NOTIFY', 'Новый матч');
...
define('_MI_GAMERS_NEWLINEUP_NOTIFY', 'Новый состав участников');
