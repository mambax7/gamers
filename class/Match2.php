...
class Match2 extends \XoopsObject
{
    ...
    public function lock()
    {
        ...
        if ($this->db->getAffectedRows() > 0) {
            redirect_header('index.php?teamid=' . $this->getVar('teamid'), 3, _MD_GAMERS_MATCHLOCKED);
        } else {
            redirect_header('availability.php?mid=' . $this->getVar('matchid'), 3, _MD_DBNOTUPDATED);
        }
    }
    ...
    public function unlock()
    {
        ...
        if ($this->db->getAffectedRows() > 0) {
            redirect_header('index.php?teamid=' . $this->getVar('teamid'), 3, _MD_GAMERS_MATCHUNLOCKED);
        } else {
            redirect_header('availability.php?mid=' . $this->getVar('matchid'), 3, _MD_DBNOTUPDATED);
        }
    }
